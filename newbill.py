...
class BillApp:
    def __init__(self,root):
        ...
        self.root.title("The Bill")
        self.root.configure(bg = 'light blue')
        title = Label(root,text = 'AGRAWAL STATIONARY',bd = 15,font =('Zefani',22,"bold"),bg = 'royal blue',fg='black',relief = GROOVE ,anchor = CENTER).pack(fill= X)
        self.nutella = IntVar()
        self.noodles = IntVar()
        self.lays = IntVar()
        self.oreo = IntVar()
        ...
        details = LabelFrame(root, text = 'Customer Details', font = ('Arial',12), bg = 'royal blue', fg = 'white',relief = GROOVE,bd = 15)
        details.place(x=0, y=80, relwidth=1)
        cust_name = Label(details,text = "Customer Name",font =('Arial',15),bg = 'royal blue',fg = 'white', ).grid(row=0,column=0,padx=10)
        cust_entry = Entry(details,font= ('Arial',10) ,borderwidth = 6, width =30,textvariable = self.c_name).grid(row=0,column=1,padx=8)
        contact_no = Label(details,text = "Contact No.",font =('Arial',15),bg = 'royal blue',fg = 'white', ).grid(row=0,column=2,padx=20)
        contact_entry = Entry(details,font= ('Arial',10),borderwidth=6, width = 25, textvariable = self.phone).grid(row=0,column=3,padx=8)
        bill_no = Label(details, text="Bill No.", font=('Arial', 15), bg='royal blue', fg='white', ).grid(row=0,column=4,  padx=10)
        bill_entry = Entry(details, font=('Arial', 10), borderwidth=6, width=30, textvariable=self.bill_no).grid(row=0,column =5, padx=8)
        snacks = LabelFrame(root,text = 'Snacks',font = ('Arial Black',12), bg= '#E5B4F3', fg = 'yellow',relief = GROOVE,bd =10)
        snacks.place(x=0,y=150, width =330)
        ...
        item7 = Label(snacks, text="Namkeen(15Rs)", font=("Arial Black", 11), bg="#E5B4F3", fg="#6C3483").grid(row=6,
                                                                                                               column=0,
                                                                                                               pady=11)
        tem7_entry = Entry(snacks, borderwidth=2, width=15, textvariable=self.namkeen).grid(row=6, column=1, padx=10)
        grocery = LabelFrame(self.root, text="Grocery", font=("Arial Black", 12), relief=GROOVE, bd=10, bg="#E5B4F3",
                             fg="#6C3483")
        grocery.place(x=340, y=150, height=380, width=325)
        ...
        hygine = LabelFrame(self.root, text="Beauty & Hygine", font=("Arial Black", 12), relief=GROOVE, bd=10,
                            bg="#E5B4F3", fg="#6C3483")
        hygine.place(x=677, y=150, height=380, width=325)
        ...
        item21_entry = Entry(hygine, borderwidth=2, width=15, textvariable=self.sanitizer).grid(row=6, column=1,
                                                                                                padx=10)
        billarea = Frame(self.root, bd=12, relief=GROOVE, bg="#E5B4F3")
        billarea.place(x=1010, y=154, width=330, height=376)
        ...
        bill_menu = LabelFrame(root,text = "Billing details",font = ("Arial",15),bg = "#E5B4F3",fg = "Blue",bd =10,relief= GROOVE)
        bill_menu.place(x=0,y=540,height =150,relwidth = 1)
        total_snacks = Label(bill_menu, text="Total Snacks Price", font=("Arial Black", 11), bg="#E5B4F3",
                             fg="#6C3483").grid(row=0, column=0)
        total_snacks_entry = Entry(bill_menu, width=25, borderwidth=2, textvariable=self.total_sna).grid(row=0,
                                                                                                            column=1,
                                                                                                            padx=10,
                                                                                                            )
        total_grocery = Label(bill_menu, text="Total Grocery Price", font=("Arial Black", 11), bg="#E5B4F3",
                              fg="#6C3483").grid(row=1, column=0)
        total_grocery_entry = Entry(bill_menu, width=25, borderwidth=2, textvariable=self.total_gro).grid(row=1,
                                                                                                             column=1,
                                                                                                             padx=10,
                                                                                                             )

        total_hygine = Label(bill_menu, text="Total Beauty & Hygine Price", font=("Arial Black", 11), bg="#E5B4F3",
                             fg="#6C3483").grid(row=2, column=0)
        total_hygine_entry = Entry(bill_menu, width=25, borderwidth=2, textvariable=self.total_hyg).grid(row=2,
                                                                                                            column=1,
                                                                                                            padx=10,
                                                                                                            )
        tax_snacks = Label(bill_menu, text="Snacks Tax", font=("Arial Black", 11), bg="#A569BD", fg="white").grid(
            row=0, column=2)
        tax_snacks_entry = Entry(bill_menu, width=25, borderwidth=2, textvariable=self.a).grid(row=0, column=3,
                                                                                                  padx=10, pady=7)

        tax_grocery = Label(bill_menu, text="Grocery Tax", font=("Arial Black", 11), bg="#A569BD", fg="white").grid(
            row=1, column=2)
        tax_grocery_entry = Entry(bill_menu, width=25, borderwidth=2, textvariable=self.b).grid(row=1, column=3,
                                                                                                   padx=10, pady=7)

        tax_hygine = Label(bill_menu, text="Beauty & Hygine Tax", font=("Arial Black", 11), bg="#A569BD",
                           fg="white").grid(row=2, column=2)
        tax_hygine_entry = Entry(bill_menu, width=25, borderwidth=2, textvariable=self.c).grid(row=2, column=3,
                                                                                                  padx=10, pady=7)
        button_frame = Frame(bill_menu, bd=7, relief=GROOVE, bg="#6C3483")
        button_frame.place(x=800,width=520, height=110)
        button_total = Button(button_frame, text="Total Bill", font=("Arial Black", 17), pady=10, bg="#E5B4F3",
                              fg="#6C3483", command=lambda: total(self)).grid(row=0, column=0, padx=10)
        button_clear = Button(button_frame, text="Clear Field", font=("Arial Black", 17), pady=10, bg="#E5B4F3",
                              fg="#6C3483", command=lambda: clear(self)).grid(row=0, column=1, padx=14, pady=6)
        button_exit = Button(button_frame, text="Exit", font=("Arial Black", 17), pady=10, bg="#E5B4F3", fg="#6C3483",
                             width=8, command=lambda: exit1(self)).grid(row=0, column=2, padx=14, pady=6)
        intro(self)
